...
localStorage.setItem("HypRev1", 3.85);
localStorage.setItem("HypRev2", 4.20);
...
var maxdedfr = (100000/v).toFixed(3);
////////////////////////////////// C23
    ...
    //if((Chef!="")&&(CatRev!="")&&(AssVie<=10000)&&(Revenu!="")){
       ...
       // document.getElementById('PaAssV1').innerHTML = 'PA de '+formatMillier(AssVie)+' TND';
        ...
        if (outRevenu>=0 && outRevenu<5000){
            var impotdu = (outRevenu-0)*0.01+0;
        }
        else if (outRevenu>=5000 && outRevenu<20000){
            var impotdu = (outRevenu-5000)*0.27+50;
        }
        else if (outRevenu>=20000 && outRevenu<30000){
            var impotdu = (outRevenu-20000)*0.29+4100;
        }
        else if (outRevenu>=30000 && outRevenu<50000){
            var impotdu = (outRevenu-30000)*0.33+7000;
        }
        else if (outRevenu>=50000){
            var impotdu = (outRevenu-50000)*0.36+13600;
        }
        if(isNaN(impotdu)){
            impotdu = 0;
        }
        ...
        if (netImpApPlPA>=0 && netImpApPlPA<5000){
            var impotduPa = (netImpApPlPA-0)*0.01+0;
        }
        else if (netImpApPlPA>=5000 && netImpApPlPA<20000){
            var impotduPa = (netImpApPlPA-5000)*0.27+50;
        }
        else if (netImpApPlPA>=20000 && netImpApPlPA<30000){
            var impotduPa = (netImpApPlPA-20000)*0.29+4100;
        }
        else if (netImpApPlPA>=30000 && netImpApPlPA<50000){
            var impotduPa = (netImpApPlPA-30000)*0.33+7000;
        }
        else if (netImpApPlPA>=50000)
		{
            var impotduPa = (netImpApPlPA-50000)*0.36+13600;
        }
        if(isNaN(impotduPa)){
            impotduPa = 0;
        }
...
var mntdeduct =AssVie;
		...
		{	alert('69');
			alert(MtntPa3);
			alert(parseFloat(MtntPaOpt2)*100000);
